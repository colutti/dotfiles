...
O repositório não é o destino nem o proprietário da configuração de runtime da máquina. Arquivos ativos permanecem locais e independentes; somente seu comportamento desejado é versionado aqui.
